...
{
    internal class EFDbContextDebugInitializer : DropCreateDatabaseAlways<EFDbContext>
    {
        protected override void Seed(EFDbContext context)
        {
            ...
            var subCategories = new List<Category>
            {
                new Category
                {
                    Name = "Food",
                    IsMainCategory = true,
                    ParentCategory = categories.Find(c => c.Name == "Grocery")
                },
                new Category
                {
                    Name = "Beverage",
                ...
                new Category
                {
                    Name = "Dining out",
                    IsMainCategory = true,
                    ParentCategory = categories.Find(c => c.Name == "Entartainment")
                },
                new Category
                {
                    Name = "Repairs",
                    IsMainCategory = true,
                    ParentCategory = categories.Find(c => c.Name == "Household")
                },
                new Category
                {
                    Name = "Furniture",
                ...
                new Category
                {
                    Name = "Cable",
                    IsMainCategory = true,
                    ParentCategory = categories.Find(c => c.Name == "Bills")
                },
                new Category
                {
                    Name = "Water",
