    ...
    public class EFDALFacade : IDALFacade
    {
        ...
        private void ReadAppConfigSettings()
        {
            ...
            switch (defaultProvider.ToUpper())
            {
                ...
                default:
                    throw new ConfigurationErrorsException(
                        "Unrecognized value for \"DisableSqlCeAsDefaultProvider\" key in app.config file");
            }
            ...
            switch (connectionOption.ToUpper())
            {
                ...
                default:
                    throw new ConfigurationErrorsException(
                        "Unrecognized value for \"KeepConnectionOpen\" key in app.config file");
            }
            ...
            if (!DisableSqlCe)
            {
                string directory = ConfigurationManager.AppSettings["DatabaseDirectory"] ??
